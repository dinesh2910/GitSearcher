...
//  GitSearcher
//
//  Created by Dinesh Danda on 4/3/20.
...
extension UIImageView {
    ...
    /**
     This Method downloads image from url and set the image to imageview. It works Asyncronously
     
     ## Important Notes ##
     1. It takes Url link and content mode as parameters
     2. Content mode is optional. By default it is set to Aspect Fit
     */
    ...
    func loadImageUsingCache(from link: String, folder: String, name: String, shouldSaveCache: Bool = true) {
     ...
     //This Method is called to set image to imageview from the url
    func downloadImage(from link: String, contentMode mode: UIView.ContentMode = .scaleAspectFit, folder: String, name: String, shouldSaveCache: Bool = true) {
        ...
        //downloadImageFromUrl(from: url, contentMode: mode)
